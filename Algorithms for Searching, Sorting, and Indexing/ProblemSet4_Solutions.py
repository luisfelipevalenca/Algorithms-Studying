...
class CountMinSketch:
    ...
    def get_random_hash_function(self):
        ...
        return lambda x: (a * x + b) % self.m

    def increment(self, word):
        hash_value = self.hash_string(word) % self.m
    ...
    def hash_string(self, word):
        return self.hash_fun_rep(hash(word))
...
class BloomFilter:
    def __init__(self, nbits, nhash):
        ...
        self.hash_fun_reps = [self.get_random_hash_function() for _ in range(self.k)]
    ...
    # Function to insert a word into the Bloom filter.
    def insert(self, word):
        for hash_fn in self.hash_fun_reps:
            index = hash_fn(word)
